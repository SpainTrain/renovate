...
function getConfig(argv) {
  ...
  function helpConsole() {
    ...
    console.log('    $ renovate --labels=renovate,dependency --ignore-unstable=false --log-level verbose singapore/lint-condo');
    console.log('    $ renovate singapore/lint-condo singapore/package-test');
    /* eslint-enable no-console */
  }

  program = program.on('--help', helpConsole).action(repositories => {
